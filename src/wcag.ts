                  ...
                  advisory: [
                    {
                      ...
                      tests: {
                        procedure:
                          'For each video element used to play a video: 1. Check that the video contains \na track element of kind descriptions in the language of the video',
                        'expected-results': 'Check #1 is true.',
                      },
                    },
                  ],
                  ...
                  failure: [
                    {
                      ...
                      tests: {
                        procedure:
                          '1. Check each text alternative to see if it is not actually a text alternative \nfor the non-text content.',
                        'expected-results':
                    ...
                    },
                    {
                      ...
                      tests: {
                        procedure:
                          'For all non-text content that requires a long description 1. Check that the long \ndescription serves the same purpose or presents the same information as the \nnon-text content.',
                        'expected-results':
                      ...
                      using: [
                        {
                          ...
                          tests: {
                            procedure:
                              '1. Enabled caption preference in player, if present 2. Play file with \ncaptions 3. Check whether captions are displayed',
                            'expected-results': '#3 is true',
                          },
                        },
                        {
                    ...
                    },
                    {
                      ...
                      using: [
                        ...
                        },
                        {
                          ...
                          tests: {
                            procedure:
                              '1. Play file with extended audio description 2. Check whether video \nfreezes in places and plays extended audio description',
                            'expected-results': '#2 is true',
                          },
                        },
                        {
                        ...
                        },
                        {
                          ...
                          tests: {
                            procedure:
                              "1. Open the HTML page for a Silverlight application, where that application \nplays media and the media is expected to support an alternate audio track \nfor the video. 2. Verify that the application user interface presents a control \nthat enables the user to cause the media to play with an alternate audio track. \n3. Activate that control. Verify that the audio portion of the media player \noutput as played through the computer's audio system is now playing the alternate audio track.",
                            'expected-results': '#2 and #3 are true.',
                          },
                        },
                        {
        ...
        },
        {
          ...
          successcriteria: [
            ...
            },
            {
              ...
              num: '2.4.7',
              dq_id: ['scrollable-region-focusable'],
              url:
            ...
            },
            {
              ...
              num: '2.4.9',
              dq_id: ['identical-links-same-purpose'],
                  ...
                  sufficient: [
                    {
                      ...
                      tests: {
                        procedure:
                          '1. Using a keyboard, cycle focus through all content 2. Check that no changes of context \noccur when any component receives focus.',
                        'expected-results': '#2 is true',
                      },
                    },
                  ],
                  ...
                  sufficient: [
                    {
                      ...
                      tests: {
                        procedure:
                          '1. Find all forms in the content 2. For each form, check that it has a submit button',
                        'expected-results': '#2 is true',
                      },
                      using: [
                        {
                  ...
                  failure: [
                    {
                      ...
                      tests: {
                        procedure:
                          '1. Enter data in all fields on page starting at top. 2. Enter data in last field and exit \nfrom it (tab out of it). 3. Check whether leaving the last field causes change of context.',
                        'expected-results':
                      ...
                      situations: [
                        {
                          ...
                          techniques: [
                            ...
                            },
                            {
                              ...
                              tests: {
                                procedure:
                                  'For form fields that require specific input: 1.Enter invalid data 2. Determine if an \nalert describing the error is provided.',
                                'expected-results': '#2 is true',
                              },
                            },
                            {
                        ...
                        },
                        {
                          ...
                          techniques: [
                            ...
                            },
                            {
                              ...
                              tests: {
                                procedure:
                                  '1. Enter invalid data in a form field. 2. Check that information is provided in text \nabout the problem.',
                                'expected-results': '#2 is true.',
                              },
                            },
                            {
                ...
                },
                {
                  advisory: [
                    ...
                    },
                    {
                      ...
                      tests: {
                        procedure:
                          '1. Fill in form fields with no errors. 2. Submit the form. 3. Check that a feedback message on the screen confirms that the submission was successful.',
                        'expected-results': 'Check #3 is true.',
                      },
                    },
                  ],
